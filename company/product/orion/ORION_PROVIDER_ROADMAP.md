...
| We Work Remotely | Public RSS exists, but official API terms prohibit using its data to build a job-search service | Do not ingest without written permission; non-binding permission inquiry sent 2026-07-19 | Written permission for the Orendalis use case |
