...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| GitHub Repository | Repositories / Source Code | Founder | Active—verify remote ownership | GitHub | N/A | N/A | [VERIFY] | [PLAN] | N/A | [OWNER] | [RECOVERY] | Critical | Source and history unavailable if lost | Verify | GitHub + local clone | Repository evidence confirmed; external account settings unverified |
