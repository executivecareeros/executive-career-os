...
| R-011 | Product | The primary beta journey lacked staging and founder acceptance evidence | Low | Critical | Founder acceptance, Atlas isolation, and Workspace isolation passed in staging on 14 July 2026 | Founder / Product | Closed 2026-07-14 | Closed |
...
| R-014 | Operations | No accepted external staging monitoring or founder alert path exists | High | High | Approve a minimal provider, configure safe signals, and test escalation before invitations | Founder / Infrastructure | Before design-partner activation | Open |
| R-015 | Delivery | Deployment checks are not yet evidenced as an organization-governed CI control | Medium | High | Verify required checks and branch controls; do not treat successful manual validation as organization CI evidence | Founder / Engineering | Before design-partner activation | Open |
