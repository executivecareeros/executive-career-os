...
export const founderActions: FounderAction[] = [
  ...
  { id: "action-beta-gates", title: "Close private-beta readiness evidence gaps", department: "Executive Office", urgency: "This Week", importance: "Critical", reason: "The readiness checklist still has unchecked authentication, isolation, email, recovery, monitoring, and support gates.", evidence: ["Private-beta gates remain unchecked in the authoritative readiness checklist."], blocker: "Production verification and founder acceptance are incomplete.", recommendedNextStep: "Review each private-beta gate and attach factual evidence or record the residual blocker.", owner: "Founder", sourceLink: sourceReferences.readiness, status: "Open", approvalRequired: true },
];
