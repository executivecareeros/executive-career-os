...
export const sourceReferences = {
  repository: "repository://f225442d07fe02ca6a537ec4a6b5c30e140427fe",
...
export const companyDataSources: CompanyDataSource[] = [
  { id: "internal-repositories", name: "Internal repositories", provider: "ORENDALIS", connectionState: "Partially Connected", authorizationState: "Not Required", lastSynchronization: "2026-07-14T00:00:00.000Z", freshness: { state: "Current", measuredAt: "2026-07-14T00:00:00.000Z", expectedFrequency: "Manual", maximumAgeInHours: 168 }, scopes: ["Aggregate repository metadata"], owner: "Founder / Engineering", health: "Healthy", recordsImported: 4, sourceReference: sourceReferences.repository },
  { id: "supabase", name: "Staging operational data", provider: "Supabase", connectionState: "Partially Connected", authorizationState: "Authorized", lastSynchronization: "2026-07-14T00:00:00.000Z", freshness: { state: "Current", measuredAt: "2026-07-14T00:00:00.000Z", expectedFrequency: "Manual", maximumAgeInHours: 168 }, scopes: ["Authenticated founder workflow", "Founder-only beta triage"], owner: "Founder / Engineering", health: "Watch", nextScheduledUpdate: "Before design-partner activation", sourceReference: "company/operations/access-and-environments/ENVIRONMENT_REGISTER.md" },
  ...
  { id: "vercel", name: "Staging deployment evidence", provider: "Vercel", connectionState: "Partially Connected", authorizationState: "Authorized", lastSynchronization: "2026-07-14T00:00:00.000Z", freshness: { state: "Current", measuredAt: "2026-07-14T00:00:00.000Z", expectedFrequency: "Manual", maximumAgeInHours: 168 }, scopes: ["Staging deployment metadata"], owner: "Founder / Infrastructure", health: "Healthy", nextScheduledUpdate: "On deployment", sourceReference: "company/operations/access-and-environments/ENVIRONMENT_REGISTER.md" },
