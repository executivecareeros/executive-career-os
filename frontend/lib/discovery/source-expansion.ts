...
export const sourceExpansionRoadmap = rankProviderExpansion([
  { id: "smartrecruiters", name: "SmartRecruiters", accessMethod: "Official employer Posting API", expectedUniqueInventory: 88, demandCoverage: 85, geographyCoverage: 90, sourceReliability: 90, accessConfidence: 85, duplicateRisk: 45, effort: 35, founderGate: false, nextAction: "Implement one employer-scoped adapter and validate terms for the intended usage." },
