...
export async function runOpportunityScheduler(client: SupabaseDataClient, now = new Date().toISOString(), maximumJobs = 20, workerCount = 2): Promise<SchedulerSummary> {
