...
assert.match(callback, /hasWorkspace = Boolean\(await resolveActiveMembership/);
assert.doesNotMatch(callback, /existing ORENDALIS executives/);
assert.match(callback, /storeSession/);
assert.match(callbackPage, /body\.hasWorkspace/);
assert.ok(callbackPage.includes('"/welcome"'));
...
assert.match(login, /create your private ORENDALIS workspace/);
