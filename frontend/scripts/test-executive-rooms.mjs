...
assert.match(roomPage,/platformOwnerIds/);
assert.match(roomPage,/names\.set\(ownerId,room\.operator_label\?\?"Atlas"\)/);
assert.match(roomPage,/message\.message_kind==="Atlas"\|\|platformOwnerIds\.has\(message\.author_identity_id\)/);
