    ...
    <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-10">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
        ...
        <div className="space-y-6">
          ...
          <OpportunityDetailSection title="Demo actions"><p className="mb-4">Status changes remain in this browser session only.</p><div className="flex flex-wrap gap-2"><PrimaryButton onClick={() => setStatus("Qualified")}>Mark qualified</PrimaryButton><SecondaryButton onClick={() => setStatus("Ready to Apply")}>Ready to apply</SecondaryButton><SecondaryButton onClick={() => setStatus("Archived")}>Archive</SecondaryButton><SecondaryButton onClick={() => setStatus("Rejected")}>Reject</SecondaryButton></div></OpportunityDetailSection>
