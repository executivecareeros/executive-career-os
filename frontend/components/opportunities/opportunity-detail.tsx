    ...
    <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-10">
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
        <div className="space-y-6">
          ...
          <details className="group rounded-2xl border border-white/10 bg-white/[.04] p-5 sm:p-6"><summary className="cursor-pointer list-none font-semibold text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400">Compensation history <span className="float-right text-slate-500 group-open:rotate-180" aria-hidden="true">⌄</span></summary><p className="mt-2 text-sm text-slate-400">Open the supporting compensation evidence when it is relevant to your decision.</p><div className="mt-5"><CompensationTimeline records={compensationForEntity(opportunity.id)} title="Opportunity Compensation Timeline" /></div></details>
          <details className="group rounded-2xl border border-white/10 bg-white/[.04] p-5 sm:p-6"><summary className="cursor-pointer list-none font-semibold text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400">Career Ledger evidence <span className="float-right text-slate-500 group-open:rotate-180" aria-hidden="true">⌄</span></summary><p className="mt-2 text-sm text-slate-400">Open the historical decision record when you need to audit how the recommendation evolved.</p><div className="mt-5"><LedgerHistoryPanel entries={ledgerForEntity(opportunity.id)} title="Linked Career Ledger events" /></div></details>
        </div>
        <div className="space-y-6">
