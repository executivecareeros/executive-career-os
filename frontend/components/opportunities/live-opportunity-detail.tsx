  ...
  return <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-10">
    ...
    <div className="mt-6 grid gap-6 xl:grid-cols-[1.3fr_.7fr]">
      ...
      <div className="space-y-6">
        ...
        <OpportunityDetailSection title="Your next decision"><p className="mb-4 text-sm text-slate-400">{opportunity.decisionComplete ? `You chose to ${opportunity.executiveDecision ?? "act"}. Atlas will keep this decision connected to the evidence and next action.` : opportunity.atlasAction ? "Atlas has assessed the evidence. Choose whether to Pursue, Watch, or Skip this opportunity." : "Ask Atlas to assess the confirmed evidence before choosing your next action."}</p><div className="flex flex-col gap-3">{opportunity.decisionComplete ? <PrimaryButton href="/archive">Review preserved decision</PrimaryButton> : <PrimaryButton href="/beta-workflow#assessment">{opportunity.atlasAction ? "Choose Pursue, Watch, or Skip" : "Ask Atlas to assess"}</PrimaryButton>}<SecondaryButton href="/companies/current">Review Company Intelligence</SecondaryButton><SecondaryButton href="/assistant">Review with Atlas</SecondaryButton></div></OpportunityDetailSection>
