...
export function LiveOpportunityDetail({ opportunity }: { opportunity: LiveOpportunityViewModel }) {
  return <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-10">
    <div className="flex flex-wrap gap-4 text-sm"><Link href="/opportunities" className="text-slate-400 hover:text-white">← Opportunity Universe</Link><Link href="/companies/current" className="text-blue-300 hover:text-blue-200">Open company profile →</Link></div>
    ...
    <div className="mt-6 grid gap-6 xl:grid-cols-[1.3fr_.7fr]">
      ...
      <div className="space-y-6">
        ...
        <OpportunityDetailSection title="Executive actions"><div className="flex flex-col gap-3"><PrimaryButton href="/assistant">Review with Atlas</PrimaryButton><SecondaryButton href="/beta-workflow#assessment">Continue decision</SecondaryButton><SecondaryButton href="/tasks">Create follow-up</SecondaryButton></div></OpportunityDetailSection>
