  ...
  return <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-10">
    ...
    <div className="mt-6 grid gap-6 xl:grid-cols-[1.3fr_.7fr]">
      ...
      <div className="space-y-6">
        ...
        <OpportunityDetailSection title="Your next decision"><p className="mb-4 text-sm text-slate-400">{opportunity.decisionComplete ? "Your decision is preserved. Review the permanent record or revisit the evidence with Atlas." : opportunity.atlasAction ? "Atlas has assessed the evidence. Confirm the action you want preserved." : "Ask Atlas to assess the confirmed evidence before choosing your next action."}</p><div className="flex flex-col gap-3">{opportunity.decisionComplete ? <PrimaryButton href="/archive">Open Career Ledger</PrimaryButton> : <PrimaryButton href="/beta-workflow#assessment">{opportunity.atlasAction ? "Continue to decision" : "Ask Atlas to assess"}</PrimaryButton>}<SecondaryButton href="/companies/current">Review Company Intelligence</SecondaryButton><SecondaryButton href="/assistant">Review with Atlas</SecondaryButton></div></OpportunityDetailSection>
