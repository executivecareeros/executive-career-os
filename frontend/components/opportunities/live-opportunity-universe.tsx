...
export function LiveOpportunityUniverse({ opportunity, collected, collectionNotice, collectionMessage, imported, found, collectionAction, initialQuery = "" }: { opportunity?: LiveOpportunityViewModel; collected: Opportunity[]; collectionNotice?: string; collectionMessage?: string; imported?: string; found?: string; collectionAction: (formData: FormData) => void | Promise<void>; initialQuery?: string }) {
  ...
  return <div className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-10">
    <PageHeader eyebrow="Jobs" title="Find your next executive role" description="Search opportunities in one place, or let Atlas narrow the field using the preferences you choose to share." actions={<SecondaryButton href="/applications">View applications</SecondaryButton>} />
