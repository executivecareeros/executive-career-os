...
const steps=[
  ...
  {label:"Atlas Assessment",key:"Reasoning",href:"#assessment",why:"Atlas compares the opportunity with confirmed evidence.",needs:"Run the deterministic assessment and review its uncertainty."},
  ...
  {label:"Feedback",key:"Feedback",href:"#feedback",why:"Private feedback improves the executive experience before beta expands.",needs:"Record what was useful, unclear, or missing."},
] as const;
